...
public class AmbientLight extends ColorLayer {
  ...
  private void renderLightSource(final Graphics2D g, final LightSource light, Rectangle2D section) {
    ...
    Area lightArea = subtractShadowArea(light);
  ...
  /**
   *  Calculates the area where shadow boxes cut the light and return the cutted light area.
   * 
   * @param light LightSource
   * @return lightArea area
   */
  private Area subtractShadowArea(LightSource light){
